  ...
  return (
    <section id="about" className="px-6 pb-24 pt-14 md:pb-32 md:pt-20">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        {/* Heading + bio + genres (right on desktop) */}
        <Reveal delay={0.1}>
          ...
          <div className="mt-8">
            <h3 className="text-sm uppercase tracking-[0.16em] text-faint">
              Genres
            </h3>
            <ul className="mt-4 flex flex-wrap gap-2">
              {site.genres.map((g) => (
                <li
                  key={g}
                  className="rounded-full border border-line bg-surface/40 px-3.5 py-1.5 text-sm text-muted"
                >
                  {g}
                </li>
              ))}
